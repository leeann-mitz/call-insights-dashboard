...
const App = (() => {
  ...
  const BEST_PRACTICES = {
    ...
    'ASR': [
      { icon:'🎯', title:'Confirm the purchase before anything else', say:'"Before we get into the details of what comes next — I want to make sure you\'re seeing everything come through on your end. You\'re all set with [product], correct?"', avoid:'"So you bought PG1, right?"', why:'ASR reps who open with a confident purchase confirmation set the tone for the entire call. The member feels taken care of, not sold to again.' },
      { icon:'📅', title:'Offer two specific appointment slots immediately', say:'"We have availability on Tuesday at 10am or Thursday at 2pm — which works better for your schedule?"', avoid:'"When would you like to book your assessment?"', why:'Two specific options close 2× faster than open-ended scheduling questions. Top ASR reps always lead with specific times, never ask the member to decide the slot first.' },
      { icon:'🏆', title:'Tie the assessment to their specific game problem', say:'"The assessment is designed to find the one thing in your swing that\'s costing you the most strokes — for most members at your level it ends up being [X]. We\'ll know exactly after your session."', avoid:'"The assessment covers your whole game."', why:'Specific framing tied to the member\'s situation dramatically increases show rates. Generic descriptions feel optional; personalized framing feels essential.' },
      { icon:'📲', title:'Send the confirmation and walk them through it live', say:'"I\'m sending you a confirmation email right now — can you check for it while we\'re on the phone? I want to make sure you have everything you need."', avoid:'"You\'ll get a confirmation in your email."', why:'Walking members through the confirmation during the call reduces no-shows by keeping the appointment front of mind and making the member feel supported.' },
      { icon:'⭐', title:'Close with a VIP coaching bridge when appropriate', say:'"One more thing before I let you go — a lot of members who go through the assessment end up asking about our VIP coaching program. If it comes up during your session, it\'s worth asking [coach name] about it. Just something to keep in mind."', avoid:'Ending the call without any mention of VIP.', why:'A soft VIP mention at the end of an ASR call plants the seed without pressure. Top reps use it consistently — it primes the coach conversation without overselling.' },
    ],
    'PG1 Closers': [
      { icon:'🎯', title:'Lead with curiosity, not the pitch', say:'"Before I tell you anything about the program — what\'s the one part of your game that\'s been costing you the most strokes?"', avoid:'"Let me tell you about PG1…"', why:'Top closers spend the first 3 minutes in discovery. They sell what the member told them they needed, not what\'s on the script.' },
      { icon:'💰', title:'Anchor value before price', say:'"Members who go through the full program typically shave 5–8 strokes in 90 days. For someone playing twice a week, that\'s a completely different game."', avoid:'"It\'s $X per month…"', why:'Reps who delay price until after value is established convert at 2× the rate of those who lead with cost.' },
      { icon:'🔄', title:'Turn declines into discoveries', say:'"I hear you — a lot of members said the same thing before they started. Can I ask what specifically makes that feel like a concern for your game?"', avoid:'"I understand, no problem."', why:'High performers treat every "no" as a missing piece of information. The real objection is almost never the stated one.' },
      { icon:'⏰', title:'Create urgency without pressure', say:'"We typically enroll 2–3 members per coach per month to keep the program personalized. I\'d hate for you to call back and have to wait."', avoid:'"This is a limited time offer…"', why:'Scarcity tied to quality (coach capacity) is believable. Discount deadlines feel fake and erode trust.' },
      { icon:'📞', title:'Always define the next step before hanging up', say:'"I\'m sending you a quick recap email right now. Can we lock in a 10-minute follow-up for Thursday at 2pm in case you have questions?"', avoid:'"Think about it and call us back."', why:'Calls that end with a defined next step convert at 3× the rate of calls that end open-ended.' },
    ],
    'Internal Setters': [
